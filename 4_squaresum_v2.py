...
class BinomialSquareVisualization(Scene):
    def construct(self):
        ...
        self.play(TransformMatchingTex(binomial_square1, binomial_square2), run_time=1)
        binomial_square3 = MathTex("(x + y)","(x + y)", "=", "xx", "+", "xy", "+", "xy", "+", "yy").to_edge(UP)
        self.play(TransformMatchingTex(binomial_square2, binomial_square3), run_time=1)
        ...
        self.play(Transform(binomial_square3_x2, square_x2), run_time=1)
        self.play(Transform(binomial_square3_y2, square_y2), run_time=1)
        self.play(Transform(binomial_square3_xy, rectangle_xy), run_time=1)
        self.play(Transform(binomial_square3_yx, rectangle_yx), run_time=1)
        ...
        self.play(Transform(binomial_square3_big, big_square), run_time=1)
        ...
        self.play(ScaleInPlace(binomial_square3[3], SCALE), run_time=RUN_TIME) # aumenta tamanho do termo
        self.play(Indicate(binomial_square3_x2), run_time=RUN_TIME)
        self.play(ScaleInPlace(binomial_square3[3], 1/SCALE), run_time=RUN_TIME)  # Retorna o termo ao tamanho original

        self.play(ScaleInPlace(binomial_square3[9], SCALE), run_time=RUN_TIME)
        self.play(Indicate(binomial_square3_y2), run_time=RUN_TIME)
        self.play(ScaleInPlace(binomial_square3[9], 1/SCALE), run_time=RUN_TIME)
        
        self.play(ScaleInPlace(binomial_square3[5], SCALE), run_time=RUN_TIME)
        self.play(Indicate(binomial_square3_xy), run_time=RUN_TIME)
        self.play(ScaleInPlace(binomial_square3[5], 1/SCALE), run_time=RUN_TIME)

        self.play(ScaleInPlace(binomial_square3[7], SCALE), run_time=RUN_TIME)
        self.play(Indicate(binomial_square3_yx), run_time=RUN_TIME)
        self.play(ScaleInPlace(binomial_square3[7], 1/SCALE), run_time=RUN_TIME)

        self.play(ScaleInPlace(binomial_square3[0:2], SCALE), run_time=RUN_TIME)
        self.play(Indicate(binomial_square3_big), run_time=RUN_TIME)
        self.play(ScaleInPlace(binomial_square3[0:2], 1/SCALE), run_time=RUN_TIME)
